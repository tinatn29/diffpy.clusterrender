...
# -*- coding: utf-8 -*-
#
# diffpy.clusterrender documentation build configuration file, created by  # noqa: E501
...
try:
    fullversion = version("diffpy.clusterrender")
except Exception:
...
# abbreviations
ab_authors = "Tina Na Narong and members of the Billinge group"
...
project = "diffpy.clusterrender"
copyright = "%Y, Trustees of UC Santa Barbara"
...
modindex_common_prefix = ["diffpy.clusterrender"]
...
html_context = {
    "display_github": True,
    "github_user": "diffpy",
    "github_repo": "diffpy.clusterrender",
    "github_version": "main",
...
basename = "diffpy.clusterrender".replace(" ", "").replace(".", "")
...
latex_documents = [
    (
        "index",
        "diffpy.clusterrender.tex",
        "diffpy.clusterrender Documentation",
        ab_authors,
        "manual",
    ),
]
